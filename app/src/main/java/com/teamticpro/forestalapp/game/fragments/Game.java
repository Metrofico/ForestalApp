    ...
    public void showPregunta(){
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                boolean atLeastOne=isAtLeastOnCheckced(group);
                if(atLeastOne){
                    ...
                    Toast.makeText(question.getMainContext(),"¡Seleccione almenos una opcion!",Toast.LENGTH_LONG).show();
                }
            }
        });
    }

    private boolean isAtLeastOnCheckced(RadioGroup group) {
